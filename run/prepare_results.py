...
seismPs_r = np.fromfile(f"{prefix}_Ps_{suffix}_" + "r_g.bin", count = nt*nr, dtype = np.float32).reshape([nt,nr], order = "F")
seismVx_r = np.fromfile(f"{prefix}_Vx_{suffix}_" + "r_g.bin", count = nt*nr, dtype = np.float32).reshape([nt,nr], order = "F")
seismVz_r = np.fromfile(f"{prefix}_Vz_{suffix}_" + "r_g.bin", count = nt*nr, dtype = np.float32).reshape([nt,nr], order = "F")

seismPs_c = np.fromfile(f"{prefix}_Ps_{suffix}_" + "c_g.bin", count = nt*nr, dtype = np.float32).reshape([nt,nr], order = "F")
seismVx_c = np.fromfile(f"{prefix}_Vx_{suffix}_" + "c_g.bin", count = nt*nr, dtype = np.float32).reshape([nt,nr], order = "F")
seismVz_c = np.fromfile(f"{prefix}_Vz_{suffix}_" + "c_g.bin", count = nt*nr, dtype = np.float32).reshape([nt,nr], order = "F")
...
ax[0].plot(amp, attPs_r, "--", color = "blue", label = "dh = 5 m")
ax[0].plot(amp, attPs_c, "--", color = "green", label = "dh = 10 m")
ax[0].plot(tracePs_r, time, color = "blue", label = "dh = 5 m")
ax[0].plot(tracePs_c, time, color = "green", label = "dh = 10 m")
ax[0].set_title("Pressure", fontsize = 15)
ax[0].set_ylabel("Time [s]", fontsize = 15)
...
ax[1].plot(amp, att, "--k")
ax[1].plot(amp, attVx_r, "--", color = "blue", label = "dh = 5 m")
ax[1].plot(amp, attVx_c, "--", color = "green", label = "dh = 10 m")
ax[1].plot(traceVx_r, time, color = "blue", label = "dh = 5 m")
ax[1].plot(traceVx_c, time, color = "green", label = "dh = 10 m")
ax[1].set_title("Vx", fontsize = 15)
ax[1].set_ylabel("Time [s]", fontsize = 15)
...
ax[2].plot(amp, att, "--k")
ax[2].plot(amp, attVz_r, "--", color = "blue", label = "dh = 5 m")
ax[2].plot(amp, attVz_c, "--", color = "green", label = "dh = 10 m")
ax[2].plot(traceVz_r, time, color = "blue", label = "dh = 5 m")
ax[2].plot(traceVz_c, time, color = "green", label = "dh = 10 m")
ax[2].set_title("Vz", fontsize = 15)
ax[2].set_ylabel("Time [s]", fontsize = 15)
