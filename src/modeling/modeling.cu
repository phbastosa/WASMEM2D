...
{
    compute_seismogram_GPU<<<sBlocks,NTHREADS>>>(d_P, d_rIdx, d_rIdz, d_rkw, d_seismogram, max_spread, timeId, tlag, nt, nzz);     
}
...
{   
    ...
    export_binary_float(data_file, h_seismogram, nt*max_spread);    
}
